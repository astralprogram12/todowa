...
class AuditAgent(BaseAgent):
    ...
    def _build_audit_system_prompt(self, prompts_dict):  # Customize this helper for each agent
...
"""
            ...
            return {
                "message": "I encountered an error while processing the audit request.",
                "actions": ["audit_error"],
                "error": str(e)
            }
