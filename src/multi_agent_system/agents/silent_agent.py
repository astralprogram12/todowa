...
class SilentAgent(BaseAgent):
    ...
    def _build_silent_system_prompt(self, prompts_dict):  # Customize this helper for each agent
...
"""
            ...
            return {
                "message": "I encountered an error while processing the silent request.",
