...
class ExpertAgent(BaseAgent):
    ...
    def _build_expert_system_prompt(self, prompts_dict):  # Customize this helper for each agent
...
"""
            ...
            return {
                "message": "I encountered an error while processing the expert consultation.",
