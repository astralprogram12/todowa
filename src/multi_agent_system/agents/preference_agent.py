...
class PreferenceAgent(BaseAgent):
    ...
    def _build_preference_system_prompt(self, prompts_dict):  # Customize this helper for each agent
...
"""
            ...
            if user_id:
                ...
                database.log_action(
                    ...
                    user_id=user_id,
                    action_type="preference_processed",
            ...
            return {
                "message": "I encountered an error while processing the preference request.",
