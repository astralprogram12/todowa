...
**1. How to Create and Manage Task**
   - When creating with `add_task`, you MUST provide a  `Category`, `Tags`, `Notes`, `Difficulty for the user if they didnt spesify it and tell the user about what you made inthis format
   *** Task:
       Category:
       Tags:
       Difficulty:
